...
CREATE TABLE `m_dept` (
  ...
  `aseet_id` varchar(255) DEFAULT NULL,
  `asset_alloc` varchar(255) DEFAULT NULL,
  `dept_id` varchar(255) DEFAULT NULL,
  `dept_name` varchar(255) DEFAULT NULL,
  `is_active` varchar(255) DEFAULT NULL,
  `is_dealloc` varchar(255) DEFAULT NULL,
  `loc_id` varchar(255) DEFAULT NULL,
  `allocate_datetime` datetime DEFAULT NULL,
  `deallocate_datetime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
