...
@Data
@Entity
@Table(name = "discovered_assets",uniqueConstraints = {
        @UniqueConstraint(columnNames = {"id"}),})
public class Discovered_assets {
	@Id
    @GeneratedValue
   private Long id;
	...
	private String MBD_serial_no;
	private String System_Model_no;
	private String System_serial_no;
	...
	public String getMonitor_make() {
		return Monitor_make;
	}
	public void setMonitor_make(String monitor_make) {
	...
	public String getMBD_serial_no() {
		return MBD_serial_no;
	}
	public void setMBD_serial_no(String mBD_serial_no) {
		MBD_serial_no = mBD_serial_no;
	}
	public String getSystem_Model_no() {
		return System_Model_no;
	}
	public void setSystem_Model_no(String system_Model_no) {
		System_Model_no = system_Model_no;
	}
	public String getSystem_serial_no() {
		return System_serial_no;
	}
	public void setSystem_serial_no(String system_serial_no) {
		System_serial_no = system_serial_no;
	}
